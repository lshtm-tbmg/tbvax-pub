...
for (i0 in 1:length(countries)) {
  ...
  for (j0 in 1:length(UID_list)) {
    ...
    for (k0 in 1:length(scenarios)) {
      ...
      ifelse(exists('art_und'),
             output_sum <- as.data.frame(cbind(treat_ds_cty$country,i,treat_ds_cty$region,treat_ds_cty$income,output_year$Year,j,k,output_year$dalys_und,output_year$dalys_d,
                                               output_year$test_ds_und+output_year$test_rr_und+output_year$treat_ds_und+output_year$treat_rr_und+output_year$art_und,output_year$vax_cost_und,
                                               output_year$test_ds_und+output_year$test_rr_und+output_year$treat_ds_und+output_year$treat_rr_und+output_year$art_und+output_year$vax_cost_und,
                                               output_year$test_ds_d+output_year$test_rr_d+output_year$treat_ds_d+output_year$treat_rr_d+output_year$art_d,output_year$vax_cost_d,
                                               output_year$test_ds_d+output_year$test_rr_d+output_year$treat_ds_d+output_year$treat_rr_d+output_year$art_d+output_year$vax_cost_d)),
             output_sum <- as.data.frame(cbind(treat_ds_cty$country,i,treat_ds_cty$region,treat_ds_cty$income,output_year$Year,j,k,output_year$dalys_und,output_year$dalys_d,
                                               output_year$test_ds_und+output_year$test_rr_und+output_year$treat_ds_und+output_year$treat_rr_und,output_year$vax_cost_und,
                                               output_year$test_ds_und+output_year$test_rr_und+output_year$treat_ds_und+output_year$treat_rr_und+output_year$vax_cost_und,
                                               output_year$test_ds_d+output_year$test_rr_d+output_year$treat_ds_d+output_year$treat_rr_d,output_year$vax_cost_d,
                                               output_year$test_ds_d+output_year$test_rr_d+output_year$treat_ds_d+output_year$treat_rr_d+output_year$vax_cost_d)))
      ...
      ## Collate DALYs and each cost category by country, year, UID, delivery scenario for undiscounted/discounted
      ifelse(exists('art_und'),
             output_disaggregated_sum <- as.data.frame(cbind(treat_ds_cty$country,i,treat_ds_cty$region,treat_ds_cty$income,output_year$Year,j,k,treated_year,output_year$dalys_und,output_year$dalys_d,
                                                             output_year$test_ds_und,output_year$test_rr_und,output_year$treat_ds_und,output_year$treat_rr_und,output_year$art_und,output_year$vax_cost_und,
                                                             output_year$test_ds_d,output_year$test_rr_d,output_year$treat_ds_d,output_year$treat_rr_d,output_year$art_d,output_year$vax_cost_d)),
             output_disaggregated_sum <- as.data.frame(cbind(treat_ds_cty$country,i,treat_ds_cty$region,treat_ds_cty$income,output_year$Year,j,k,treated_year,output_year$dalys_und,output_year$dalys_d,
                                                             output_year$test_ds_und,output_year$test_rr_und,output_year$treat_ds_und,output_year$treat_rr_und,output_year$vax_cost_und,
                                                             output_year$test_ds_d,output_year$test_rr_d,output_year$treat_ds_d,output_year$treat_rr_d,output_year$vax_cost_d)))
      ifelse(exists('art_und'),
             colnames(output_disaggregated_sum) <- c("country","code","region","income","year","UID","scenario","cases","dalys_und","dalys_d","test_ds_und","test_rr_und","treat_ds_und","treat_rr_und","art_und","vax_cost_und","test_ds_d","test_rr_d","treat_ds_d","treat_rr_d","art_d","vax_cost_d"),
             colnames(output_disaggregated_sum) <- c("country","code","region","income","year","UID","scenario","cases","dalys_und","dalys_d","test_ds_und","test_rr_und","treat_ds_und","treat_rr_und","vax_cost_und","test_ds_d","test_rr_d","treat_ds_d","treat_rr_d","vax_cost_d"))
  ...
  write.csv(output_disaggregated_all,paste0(i,"_disaggregated.csv"),row.names=FALSE)
