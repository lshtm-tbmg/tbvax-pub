run_param_set_epi_econ <- function(model, cc, params, params_uid, vx_chars, rr_pct) {
  ...
  # n_epi (cases, treatments, deaths for the whole population)
  if (T){ 
  ...
  if(T){
    ...
    stocks_ipj <- stocks_ipj[Year < 2051]
