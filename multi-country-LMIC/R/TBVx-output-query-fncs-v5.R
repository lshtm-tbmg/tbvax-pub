...
exclude.not.alive=function(z){ # extend later to include SES and VXa ; see readme.txt
  hivnotalive  = grepl("dead$",z$HIV,ignore.case = T)  | grepl("count$",z$HIV,ignore.case = T) 
  tbnotalive   = grepl("dead$",z$TB,ignore.case = T)   | grepl("count$",z$TB,ignore.case = T)
  risknotalive = grepl("dead$",z$RISK,ignore.case = T) | grepl("count$",z$RISK,ignore.case = T)
  z[!(hivnotalive | tbnotalive | risknotalive),]
}
