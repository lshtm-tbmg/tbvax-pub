...
parse.run.spec = function(xmlfile=NA){
  ...
  p$num.int = rk.parameters(p$num.int,xmldoc,xmlschema,path="//simulation/options/numerical.integration",
                    names=c("method","maxsteps","hmin","hini","atol","rtol"),
                    types=c("text","integer","double","double","double","double"))
  p$num.int = rk.parameters(p$num.int,xmldoc,xmlschema,path="//simulation/options/exceptional.conditions",
