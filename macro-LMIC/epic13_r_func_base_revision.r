...
tbmacro <- function(index){
  ...
  directory <- paste0("/n/holyscratch01/menzies_lab/Lab/MacroRevision/tbvax/econ_output/")
  ...
  country_cost0 <- read.csv(paste0("/n/holyscratch01/menzies_lab/Lab/AllisonEconOutput/outcomes/",i,"_outcomes_macro.csv"),header=TRUE,check.names=FALSE)
  ...
  write.csv(output_all,paste0("/n/holyscratch01/menzies_lab/Lab/AllisonEconOutput/macro/",i,"_macro.csv"),row.names=FALSE)
