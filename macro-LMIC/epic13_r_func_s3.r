...
tbmacro <- function(index){
  ...
  country_cost0 <- read.csv(paste0("/n/holyscratch01/menzies_lab/Lab/AllisonEconOutput/outcomes/",i,"_outcomes_macro_s3.csv"),header=TRUE,check.names=FALSE)
  ...
  write.csv(output_all,paste0("/n/holyscratch01/menzies_lab/Lab/AllisonEconOutput/macro/",i,"_macro_s3.csv"),row.names=FALSE)
