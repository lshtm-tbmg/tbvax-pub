...
tbmacro <- function(index){
  ...
  country_cost0 <- read.csv(paste0("/n/holyscratch01/menzies_lab/Lab/AllisonEconOutput/outcomes/",i,"_outcomes_macro_s6.csv"),header=TRUE,check.names=FALSE)
      ...
      cipe <- function(alpha_vals,  # edited NAM Aug-11
        ...
        for (t in 2:T) {
          L[t] <-
            ...
            lfp15_19 * cud$rho15 * (LV15[t] + z15[t] + b15[t]) +  
            lfp15_19 * cud$rho16 * (LV16[t] + z16[t] + b16[t]) + 
            lfp15_19 * cud$rho17 * (LV17[t] + z17[t] + b17[t]) + 
            lfp15_19 * cud$rho18 * (LV18[t] + z18[t] + b18[t]) + 
            lfp15_19 * cud$rho19 * (LV19[t] + z19[t] + b19[t]) +
            lfp20_24 * cud$rho20 * (LV20[t] + z20[t] + b20[t]) +
            lfp20_24 * cud$rho21 * (LV21[t] + z21[t] + b21[t]) +
            lfp20_24 * cud$rho22 * (LV22[t] + z22[t] + b22[t]) +
            lfp20_24 * cud$rho23 * (LV23[t] + z23[t] + b23[t]) +
            lfp20_24 * cud$rho24 * (LV24[t] + z24[t] + b24[t]) +
            lfp25_29 * cud$rho25 * (LV25[t] + z25[t] + b25[t]) +
            lfp25_29 * cud$rho26 * (LV26[t] + z26[t] + b26[t]) +
            lfp25_29 * cud$rho27 * (LV27[t] + z27[t] + b27[t]) +
            lfp25_29 * cud$rho28 * (LV28[t] + z28[t] + b28[t]) +
            lfp25_29 * cud$rho29 * (LV29[t] + z29[t] + b29[t]) +
            lfp30_34 * cud$rho30 * (LV30[t] + z30[t] + b30[t]) +
            lfp30_34 * cud$rho31 * (LV31[t] + z31[t] + b31[t]) +
            lfp30_34 * cud$rho32 * (LV32[t] + z32[t] + b32[t]) +
            lfp30_34 * cud$rho33 * (LV33[t] + z33[t] + b33[t]) +
            lfp30_34 * cud$rho34 * (LV34[t] + z34[t] + b34[t]) +
            lfp35_39 * cud$rho35 * (LV35[t] + z35[t] + b35[t]) +
            lfp35_39 * cud$rho36 * (LV36[t] + z36[t] + b36[t]) +
            lfp35_39 * cud$rho37 * (LV37[t] + z37[t] + b37[t]) +
            lfp35_39 * cud$rho38 * (LV38[t] + z38[t] + b38[t]) +
            lfp35_39 * cud$rho39 * (LV39[t] + z39[t] + b39[t]) +
            lfp40_44 * cud$rho40 * (LV40[t] + z40[t] + b40[t]) +
            lfp40_44 * cud$rho41 * (LV41[t] + z41[t] + b41[t]) +
            lfp40_44 * cud$rho42 * (LV42[t] + z42[t] + b42[t]) +
            lfp40_44 * cud$rho43 * (LV43[t] + z43[t] + b43[t]) +
            lfp40_44 * cud$rho44 * (LV44[t] + z44[t] + b44[t]) +
            lfp45_49 * cud$rho45 * (LV45[t] + z45[t] + b45[t]) +
            lfp45_49 * cud$rho46 * (LV46[t] + z46[t] + b46[t]) +
            lfp45_49 * cud$rho47 * (LV47[t] + z47[t] + b47[t]) +
            lfp45_49 * cud$rho48 * (LV48[t] + z48[t] + b48[t]) +
            lfp45_49 * cud$rho49 * (LV49[t] + z49[t] + b49[t]) +
            lfp50_54 * cud$rho50 * (LV50[t] + z50[t] + b50[t]) +
            lfp50_54 * cud$rho51 * (LV51[t] + z51[t] + b51[t]) +
            lfp50_54 * cud$rho52 * (LV52[t] + z52[t] + b52[t]) +
            lfp50_54 * cud$rho53 * (LV53[t] + z53[t] + b53[t]) +
            lfp50_54 * cud$rho54 * (LV54[t] + z54[t] + b54[t]) +
            lfp55_59 * cud$rho55 * (LV55[t] + z55[t] + b55[t]) +
            lfp55_59 * cud$rho56 * (LV56[t] + z56[t] + b56[t]) +
            lfp55_59 * cud$rho57 * (LV57[t] + z57[t] + b57[t]) +
            lfp55_59 * cud$rho58 * (LV58[t] + z58[t] + b58[t]) +
            lfp55_59 * cud$rho59 * (LV59[t] + z59[t] + b59[t]) +
            lfp60_64 * cud$rho60 * (LV60[t] + z60[t] + b60[t]) +
            lfp60_64 * cud$rho61 * (LV61[t] + z61[t] + b61[t]) +
            lfp60_64 * cud$rho62 * (LV62[t] + z62[t] + b62[t]) +
            lfp60_64 * cud$rho63 * (LV63[t] + z63[t] + b63[t]) +
            lfp60_64 * cud$rho64 * (LV64[t] + z64[t] + b64[t]) +
            lfpGE65  * cud$rho65 * (LV65[t] + z65[t] + b65[t]) +
            lfpGE65  * cud$rho66 * (LV66[t] + z66[t] + b66[t]) +
            lfpGE65  * cud$rho67 * (LV67[t] + z67[t] + b67[t]) +
            lfpGE65  * cud$rho68 * (LV68[t] + z68[t] + b68[t]) +
            lfpGE65  * cud$rho69 * (LV69[t] + z69[t] + b69[t]) +
  ...
  write.csv(output_all,paste0("/n/holyscratch01/menzies_lab/Lab/AllisonEconOutput/macro/",i,"_macro_s6.csv"),row.names=FALSE)
