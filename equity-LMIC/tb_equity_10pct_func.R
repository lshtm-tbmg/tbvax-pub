...
cc_all <- read.csv("/n/holyscratch01/menzies_lab/Lab/AllisonEconOutput/data/cc_all_10pct.csv",header=TRUE,check.names=FALSE)
oop_all <- read.csv("/n/holyscratch01/menzies_lab/Lab/AllisonEconOutput/data/oop_all_10pct.csv",header=TRUE,check.names=FALSE)
...
# calc all results then separate step for summary statistics
    ...
    for (k in scenarios) {
      ...
      cc_untreated_richest <- cc2[5]*untreated_richest
      cc_untreated_richer <- cc2[4]*untreated_richer
      cc_untreated_middle <- cc2[3]*untreated_middle
      cc_untreated_poorer <- cc2[2]*untreated_poorer
      cc_untreated_poorest <- cc2[1]*untreated_poorest
      
      oop_untreated_richest <- oop2[5]*untreated_richest
      oop_untreated_richer <- oop2[4]*untreated_richer
      oop_untreated_middle <- oop2[3]*untreated_middle
      oop_untreated_poorer <- oop2[2]*untreated_poorer
      oop_untreated_poorest <- oop2[1]*untreated_poorest
  ...
  write.csv(output_all,paste0("/n/holyscratch01/menzies_lab/Lab/AllisonEconOutput/equity_10pct/",i,"_equity.csv"),row.names=FALSE)
  rm(output)
